...
export const translations = {
  ru: {
    ...
    tab_bookmarks: "Мои закладки и списки",
    
    // Источники и виды
    source_all: "Все источники",
    source_fanfilm: "FanFilm4K (4K UHD)",
    source_anixart: "AniXart (Аниме)",
    view_grid: "Сетка",
  ...
  en: {
    ...
    tab_bookmarks: "My bookmarks and lists",
    
    source_all: "All sources",
    source_fanfilm: "FanFilm4K (4K UHD)",
    source_anixart: "AniXart (Anime)",
    view_grid: "Grid",
  ...
  de: {
    ...
    tab_bookmarks: "Meine Lesezeichen und Listen",
  ...
  fr: {
    ...
    tab_bookmarks: "Mes favoris et listes",
    
    source_all: "Toutes les sources",
    source_fanfilm: "FanFilm4K (4K UHD)",
    source_anixart: "AniXart (Animé)",
    view_grid: "Grille",
  ...
  zh: {
    ...
    tab_cartoons: "动画片",
    tab_continue: "继续观看",
    tab_bookmarks: "我的收藏与列表",
    
    source_all: "所有来源",
    source_fanfilm: "FanFilm4K (4K 超清)",
    source_anixart: "AniXart (动画)",
    view_grid: "网格视图",
  ...
  ja: {
    ...
    tab_cartoons: "カートゥーン",
    tab_continue: "続きを見る",
    tab_bookmarks: "ブックマークとリスト",
    
    source_all: "すべてのソース",
    source_fanfilm: "FanFilm4K (4K UHD)",
    source_anixart: "AniXart (アニメ)",
    view_grid: "グリッド",
