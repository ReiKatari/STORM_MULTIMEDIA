// STORM MULTIMEDIA - Baseline & Fallback Generator (24 items per category)
import fs from 'fs';
...
const MOVIES = [
  ...
  },
  {
    ...
    media_type: "movie",
    category: "Фильм",
    genres: ["Боевик", "Фантастика", "Драма"],
    source: "tmdb",
...
const CARTOONS = [
  ...
  },
  {
    ...
    media_type: "cartoons",
    category: "Мультфильм",
    genres: ["Мультфильм", "Драма", "Семейный"],
    source: "tmdb",
  ...
  },
  {
    ...
    media_type: "cartoons",
    category: "Мультфильм",
    genres: ["Мультфильм", "Боевик", "Семейный"],
    source: "tmdb",
  ...
  },
  {
    ...
    media_type: "cartoons",
    category: "Мультфильм",
    genres: ["Мультфильм", "Аниме", "Фэнтези"],
    source: "tmdb",
...
const CARTOON_SERIES = [
  ...
  },
  {
    ...
    media_type: "cartoon-series",
    category: "Мультсериал",
    genres: ["Фэнтези", "Приключения", "Детектив"],
    source: "tmdb",
...
const ANIME_MOVIES = [
  ...
  },
  {
    ...
    media_type: "anime-movie",
    category: "Аниме",
    genres: ["Аниме", "Романтика", "Фэнтези"],
    source: "shikimori",
  ...
  },
  {
    ...
    media_type: "anime-movie",
    category: "Аниме",
    genres: ["Аниме", "Фантастика", "Боевик"],
    source: "shikimori",
  ...
  },
  {
    ...
    media_type: "anime-movie",
    category: "Аниме",
    genres: ["Аниме", "Фэнтези", "Фантастика"],
    source: "shikimori",
  ...
  },
  {
    ...
    media_type: "anime-movie",
    category: "Аниме",
    genres: ["Аниме", "Фантастика", "Детектив"],
    source: "shikimori",
...
const ANIME_SERIES = [
  ...
  },
  {
    ...
    media_type: "anime-series",
    category: "Аниме",
    genres: ["Аниме", "Боевик", "Сверхъестественное"],
    source: "anilibria",
  ...
  },
  {
    ...
    media_type: "anime-series",
    category: "Аниме",
    genres: ["Аниме", "Фантастика", "Триллер"],
    source: "anilibria",
  ...
  },
  {
    ...
    media_type: "anime-series",
    category: "Аниме",
    genres: ["Аниме", "Фантастика", "Психология"],
    source: "anilibria",
  ...
  },
  {
    ...
    media_type: "anime-series",
    category: "Аниме",
    genres: ["Аниме", "Тёмное фэнтези", "Боевик"],
    source: "anilibria",
    description: "Одинокий мечник Гатс вступает в отряд наемников «Банда Ястреба» под началом харизматичного Гриффита."
  }
];

// 24 новинки: подборка свежих хитов 2024-2026
const NEW_ITEMS = [
  MOVIES[0], // Человек-паук: Новый день (2026)
  SERIES[0], // Джентльмены (2024)
  MOVIES[1], // Дюна: Часть вторая (2024)
  SERIES[1], // Пингвин (2024)
  MOVIES[4], // Гладиатор 2 (2024)
  SERIES[2], // Сёгун (2024)
  CARTOON_SERIES[0], // Аркейн 2 (2024)
  ANIME_SERIES[0], // Поднятие уровня в одиночку 2 (2025)
  MOVIES[3], // Дэдпул и Росомаха (2024)
  SERIES[3], // Фоллаут (2024)
  CARTOONS[0], // Дикий робот (2024)
  SERIES[13], // Укрытие 2 (2024)
  MOVIES[6], // Субстанция (2024)
  MOVIES[7], // Чужой: Ромул (2024)
  SERIES[4], // Пацаны (2024)
  CARTOONS[1], // Головоломка 2 (2024)
  SERIES[5], // Дом Дракона (2024)
  MOVIES[8], // Фуриоса (2024)
  ANIME_SERIES[4], // Фрирен (2024)
  CARTOON_SERIES[3], // Неуязвимый (2024)
  SERIES[14], // Медленные лошади (2024)
  MOVIES[9], // Падение империи (2024)
  CARTOONS[3], // Гадкий я 4 (2024)
  ANIME_MOVIES[20] // Оглянись (2024)
];

// 24 популярных релиза для главной
const POPULAR_ITEMS = [
  MOVIES[0], // Человек-паук: Новый день
  MOVIES[1], // Дюна: Часть вторая
  SERIES[1], // Пингвин
  MOVIES[3], // Дэдпул и Росомаха
  SERIES[2], // Сёгун
  CARTOON_SERIES[0], // Аркейн 2
  SERIES[3], // Фоллаут
  CARTOONS[0], // Дикий робот
  ANIME_SERIES[0], // Поднятие уровня в одиночку
  MOVIES[4], // Гладиатор 2
  MOVIES[2], // Оппенгеймер
  SERIES[0], // Джентльмены
  MOVIES[5], // Интерстеллар
  SERIES[4], // Пацаны
  CARTOONS[1], // Головоломка 2
  ANIME_SERIES[1], // Клинок, рассекающий демонов
  MOVIES[6], // Субстанция
  SERIES[7], // Во все тяжкие
  ANIME_SERIES[3], // Атака титанов
  CARTOON_SERIES[1], // Рик и Морти
  MOVIES[10], // Тёмный рыцарь
  CARTOONS[2], // Человек-паук: Паутина вселенных
  ANIME_MOVIES[0], // Мальчик и птица
  ANIME_MOVIES[1] // Твоё имя
];
...
// Генерация catalog-baseline.js (ES Module)
const baselineContent = `// STORM MULTIMEDIA - Клиентский проверенный базовый каталог для мгновенной гидратации (LCP < 50ms)
// Содержит по 24 проверенных карточки для каждой категории

export const VERIFIED_CATALOG_BASELINE = ${JSON.stringify(BASELINE_DATA, null, 2)};
...
// Генерация services/catalog-fallback.js (Server Common/ES Module with SQLite)
const fallbackContent = `import { db } from "../db.js";

export const VERIFIED_CATALOG_FALLBACK = ${JSON.stringify(BASELINE_DATA, null, 2)};
...
fs.writeFileSync(path.resolve('public/js/catalog-baseline.js'), baselineContent, 'utf8');
console.log('Updated public/js/catalog-baseline.js (24 items per category)');

fs.writeFileSync(path.resolve('services/catalog-fallback.js'), fallbackContent, 'utf8');
console.log('Updated services/catalog-fallback.js (24 items per category)');

const androidBaselinePath = path.resolve('android_build/app/src/main/assets/js/catalog-baseline.js');
if (fs.existsSync(path.dirname(androidBaselinePath))) {
  fs.writeFileSync(androidBaselinePath, baselineContent, 'utf8');
  console.log('Updated android_build/app/src/main/assets/js/catalog-baseline.js');
}
