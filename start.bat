...
echo [ИНФО] Запуск локального сервера STORM MULTIMEDIA на порту 3000...
...
:already_running
echo [ИНФО] Сервер STORM MULTIMEDIA уже запущен на порту 3000.
echo [ИНФО] Открытие веб-интерфейса в браузере: http://localhost:3000
start "" "http://localhost:3000"
goto end
